...
export default function ProfilePage() {
  ...
  const mut = useMutation({
    ...
    onSuccess: () => { message.success('密码已更新'); form.resetFields(); },
  ...
  return (
    <Card
      className="glow-box"
      bordered={false}
      title={<span className="tech-title" style={{ fontSize: 13 }}>PROFILE · CHANGE PASSWORD</span>}
      style={{ maxWidth: 480 }}
    >
      <Form
        form={form}
      ...
      >
        ...
        <Button type="primary" htmlType="submit" loading={mut.isPending}>保存</Button>
      </Form>
    </Card>
  );
}
